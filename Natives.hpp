...
#include "Invoker.hpp"
#define Any int32_t
#define Hash uint32_t
#define Void int32_t
#define Entity int32_t
#define Vector3 rage::NativeVector3
#define Vehicle Entity
#define Ped Entity
#define Player Entity
#define Object Entity
#define Cam Entity
#define ScrHandle Entity
#define Blip Entity
#define Pickup Entity
#pragma warning(push)
#pragma warning(disable : 4505)
template <typename R, typename ...TArgs>
inline R invoke(std::uint64_t hash, TArgs... args) {
	ClassPointers::cInvoker->BeginCall();
	(ClassPointers::cInvoker->Push(args), ...);
	ClassPointers::cInvoker->EndCall(hash);
	return ClassPointers::cInvoker->GetReturn<R>();
}
...
namespace SYSTEM
{
	...
	inline void _0x42B65DEEF2EDF2A1(Any p0) { invoke<Void>(0x42B65DEEF2EDF2A1, p0); } // 0x42B65DEEF2EDF2A1 
	...
	inline int START_NEW_SCRIPT(const char* scriptName, int stackSize) { return invoke<int>(0xE81651AD79516E48, scriptName, stackSize); } // 0xE81651AD79516E48 0x3F166D0E
	inline int START_NEW_SCRIPT_WITH_ARGS(const char* scriptName, Any* args, int argCount, int stackSize) { return invoke<int>(0xB8BA7F44DF1575E1, scriptName, args, argCount, stackSize); } // 0xB8BA7F44DF1575E1 0x4A2100E4
...
namespace APP
{
	...
	inline BOOL APP_DATA_VALID() { return invoke<BOOL>(0x846AA8E7D55EE5B6); } // 0x846AA8E7D55EE5B6 0x72BDE002
	inline BOOL APP_DELETE_APP_DATA(const char* appName) { return invoke<BOOL>(0x44151AEA95C8A003, appName); } // 0x44151AEA95C8A003 0x2A2FBD1C
	inline Any APP_GET_DELETED_FILE_STATUS() { return invoke<Any>(0xC9853A2BE3DED1A6); } // 0xC9853A2BE3DED1A6 0x784D550B
	inline float APP_GET_FLOAT(const char* property) { return invoke<float>(0x1514FB24C02C2322, property); } // 0x1514FB24C02C2322 0xD87F3A1C
	inline int APP_GET_INT(const char* property) { return invoke<int>(0xD3A58A12C77D9D4B, property); } // 0xD3A58A12C77D9D4B 0x2942AAD2
	inline const char* APP_GET_STRING(const char* property) { return invoke<const char*>(0x749B023950D2311C, property); } // 0x749B023950D2311C 0x849CEB80
	inline BOOL APP_HAS_LINKED_SOCIAL_CLUB_ACCOUNT() { return invoke<BOOL>(0x71EEE69745088DA0); } // 0x71EEE69745088DA0 0xD368BA15
	inline BOOL APP_HAS_SYNCED_DATA(const char* appName) { return invoke<BOOL>(0xCA52279A7271517F, appName); } // 0xCA52279A7271517F 0x1DE2A63D
	inline void APP_SAVE_DATA() { invoke<Void>(0x95C5D356CDA6E85F); } // 0x95C5D356CDA6E85F 0x84A3918D
	inline void APP_SET_APP(const char* appName) { invoke<Void>(0xCFD0406ADAF90D2B, appName); } // 0xCFD0406ADAF90D2B 0x8BAC4146
	inline void APP_SET_BLOCK(const char* blockName) { invoke<Void>(0x262AB456A3D21F93, blockName); } // 0x262AB456A3D21F93 0xC2D54DD9
	inline void APP_SET_FLOAT(const char* property, float value) { invoke<Void>(0x25D7687C68E0DAA4, property, value); } // 0x25D7687C68E0DAA4 0xF3076135
	inline void APP_SET_INT(const char* property, int value) { invoke<Void>(0x607E8E3D3E4F9611, property, value); } // 0x607E8E3D3E4F9611 0x1B509C32
	inline void APP_SET_STRING(const char* property, const char* value) { invoke<Void>(0x3FF2FCEC4B7721B4, property, value); } // 0x3FF2FCEC4B7721B4 0x23DF19A8
}

namespace AUDIO
{
	inline void STOP_STREAM() { invoke<Void>(0xA4718A1419D18151); } // 0xA4718A1419D18151 0xD1E364DE
	inline void _0xD01005D2BA2EB778(Any* p0) { invoke<Void>(0xD01005D2BA2EB778, p0); } // 0xD01005D2BA2EB778 0x59A3A17D
	inline void _DYNAMIC_MIXER_RELATED_FN(Entity p0, const char* p1, float p2) { invoke<Void>(0x153973AB99FE8980, p0, p1, p2); } // 0x153973AB99FE8980 0x2BC93264
	inline void ADD_LINE_TO_CONVERSATION(int p0, const char* p1, const char* p2, int p3, int p4, bool p5, bool p6, bool p7, bool p8, int p9, bool p10, bool p11, bool p12) { invoke<Void>(0xC5EF963405593646, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12); } // 0xC5EF963405593646 0x96CD0513
	inline void ADD_PED_TO_CONVERSATION(Any p0, Any ped, const char* p2) { invoke<Void>(0x95D9F4BC443956E7, p0, ped, p2); } // 0x95D9F4BC443956E7 0xF8D5EB86
	inline Any _0x3D120012440E6683() { return invoke<Any>(0x3D120012440E6683); } // 0x3D120012440E6683 
	inline Any AUDIO_IS_SCRIPTED_MUSIC_PLAYING() { return invoke<Any>(0x845FFC3A4FEEFA3E); } // 0x845FFC3A4FEEFA3E 0x86E995D1
	...
	inline BOOL CANCEL_MUSIC_EVENT(const char* eventName) { return invoke<BOOL>(0x5B17A90291133DA5, eventName); } // 0x5B17A90291133DA5 0x89FF942D
	...
	inline void CLEAR_AMBIENT_ZONE_STATE(const char* zoneName, bool p1) { invoke<Void>(0x218DD44AAAC964FF, zoneName, p1); } // 0x218DD44AAAC964FF 0xCDFF3C82
	inline void _0x1654F24A88A8E3FE(const char* radioStation) { invoke<Void>(0x1654F24A88A8E3FE, radioStation); } // 0x1654F24A88A8E3FE 0x1D766976
	inline void CREATE_NEW_SCRIPTED_CONVERSATION() { invoke<Void>(0xD2C91A0B572AAE56); } // 0xD2C91A0B572AAE56 0xB2BC25F8
	inline void _0xDDC635D5B3262C56(Any* p0) { invoke<Void>(0xDDC635D5B3262C56, p0); } // 0xDDC635D5B3262C56 0x0E387BFE
	...
	inline BOOL _CAN_PED_SPEAK(Ped ped, const char* speechName, bool unk) { return invoke<BOOL>(0x49B99BF3FDA89A7A, ped, speechName, unk); } // 0x49B99BF3FDA89A7A 0x8BD5F11E
	...
	inline void _0xB81CF134AEB56FFB() { invoke<Void>(0xB81CF134AEB56FFB); } // 0xB81CF134AEB56FFB 
	...
	inline void _SET_VEHICLE_AUDIO(Vehicle vehicle, const char* audioName) { invoke<Void>(0x4F0C413926060B38, vehicle, audioName); } // 0x4F0C413926060B38 0x33B0B007
	inline void _0xD57AAAE0E2214D11() { invoke<Void>(0xD57AAAE0E2214D11); } // 0xD57AAAE0E2214D11 
	inline void FREEZE_RADIO_STATION(const char* radioStation) { invoke<Void>(0x344F393B027E38C3, radioStation); } // 0x344F393B027E38C3 0x286BF543
	inline Any _0x5E203DA2BA15D436(Any p0) { return invoke<Any>(0x5E203DA2BA15D436, p0); } // 0x5E203DA2BA15D436 
	...
	inline Any _0xE73364DB90778FFA() { return invoke<Any>(0xE73364DB90778FFA); } // 0xE73364DB90778FFA 0x336F3D35
	inline Any GET_MUSIC_PLAYTIME() { return invoke<Any>(0xE7A0D23DC414507B); } // 0xE7A0D23DC414507B 0xD633C809
	inline Any _0x3A48AB4445D499BE() { return invoke<Any>(0x3A48AB4445D499BE); } // 0x3A48AB4445D499BE 0x93A44A1F
	...
	inline const char* GET_PLAYER_RADIO_STATION_NAME() { return invoke<const char*>(0xF6D733C32076AD03); } // 0xF6D733C32076AD03 0xD909C107
	inline const char* GET_RADIO_STATION_NAME(int radioStation) { return invoke<const char*>(0xB28ECA15046CA8B9, radioStation); } // 0xB28ECA15046CA8B9 0x3DF493BC
	...
	inline Any _0x544810ED9DB6BBE6() { return invoke<Any>(0x544810ED9DB6BBE6); } // 0x544810ED9DB6BBE6 
	inline Any _0x5B50ABB1FE3746F4() { return invoke<Any>(0x5B50ABB1FE3746F4); } // 0x5B50ABB1FE3746F4 
	inline BOOL HAS_SOUND_FINISHED(int soundId) { return invoke<BOOL>(0xFCBDCE714A7C88E5, soundId); } // 0xFCBDCE714A7C88E5 0xE85AEC2E
	inline Any _0x40763EA7B9B783E7(Any p0, Any p1, Any p2) { return invoke<Any>(0x40763EA7B9B783E7, p0, p1, p2); } // 0x40763EA7B9B783E7 
	inline Any HINT_AMBIENT_AUDIO_BANK(Any p0, Any p1, Any p2) { return invoke<Any>(0x8F8C0E370AE62F5C, p0, p1, p2); } // 0x8F8C0E370AE62F5C 0xF1850DDC
	inline Any HINT_SCRIPT_AUDIO_BANK(Any p0, Any p1, Any p2) { return invoke<Any>(0xFB380A29641EC31A, p0, p1, p2); } // 0xFB380A29641EC31A 0x41FA0E51
	inline void _SET_SYNCHRONIZED_AUDIO_EVENT_POSITION_THIS_FRAME(const char* p0, Entity p1) { invoke<Void>(0x950A154B8DAB6185, p0, p1); } // 0x950A154B8DAB6185 0xA17F9AB0
	...
	inline void _0x8A694D7A68F8DC38(Ped p0, const char* p1, const char* p2) { invoke<Void>(0x8A694D7A68F8DC38, p0, p1, p2); } // 0x8A694D7A68F8DC38 0xDD4A3F1F
	inline BOOL IS_ALARM_PLAYING(const char* alarmName) { return invoke<BOOL>(0x226435CB96CCFC8C, alarmName); } // 0x226435CB96CCFC8C 0x9D8E1D23
	...
	inline BOOL IS_AMBIENT_ZONE_ENABLED(const char* ambientZone) { return invoke<BOOL>(0x01E2817A479A7F9B, ambientZone); } // 0x01E2817A479A7F9B 0xBFABD872
	...
	inline BOOL IS_AUDIO_SCENE_ACTIVE(const char* scene) { return invoke<BOOL>(0xB65B60556E2A9225, scene); } // 0xB65B60556E2A9225 0xACBED05C
	...
	inline Any _0x6F259F82D873B8B8() { return invoke<Any>(0x6F259F82D873B8B8); } // 0x6F259F82D873B8B8 0xCBE09AEC
	...
	inline Any _0xC8B1B2425604CDD0() { return invoke<Any>(0xC8B1B2425604CDD0); } // 0xC8B1B2425604CDD0 0x16FB88B5
	...
	inline Any _0x0626A247D2405330() { return invoke<Any>(0x0626A247D2405330); } // 0x0626A247D2405330 0x815CAE99
	...
	inline Any _0x0BE4BE946463F917(Any p0) { return invoke<Any>(0x0BE4BE946463F917, p0); } // 0x0BE4BE946463F917 
	inline void _0x651D3228960D08AF(Any p0, Any p1) { invoke<Void>(0x651D3228960D08AF, p0, p1); } // 0x651D3228960D08AF 
	inline BOOL LOAD_STREAM(const char* streamName, const char* soundSet) { return invoke<BOOL>(0x1F1F957154EC51DF, streamName, soundSet); } // 0x1F1F957154EC51DF 0x0D89599D
	inline BOOL LOAD_STREAM_WITH_START_OFFSET(const char* streamName, int startOffset, const char* soundSet) { return invoke<BOOL>(0x59C16B79F53B3712, streamName, startOffset, soundSet); } // 0x59C16B79F53B3712 0xE5B5745C
	...
	inline void OVERRIDE_TREVOR_RAGE(Any* p0) { invoke<Void>(0x13AD665062541A7E, p0); } // 0x13AD665062541A7E 0x05B9B5CF
	...
	inline void _PLAY_AMBIENT_SPEECH_AT_COORDS(const char* p0, const char* p1, float p2, float p3, float p4, const char* p5) { invoke<Void>(0xED640017ED337E45, p0, p1, p2, p3, p4, p5); } // 0xED640017ED337E45 0xA1A1402E
	...
	inline void _0xCADA5A0D0702381E(const char* p0, const char* soundset) { invoke<Void>(0xCADA5A0D0702381E, p0, soundset); } // 0xCADA5A0D0702381E 0xC70E6CFA
	inline void PLAY_END_CREDITS_MUSIC(bool play) { invoke<Void>(0xCD536C4D33DCC900, play); } // 0xCD536C4D33DCC900 0x8E88B3CC
	inline void PLAY_MISSION_COMPLETE_AUDIO(const char* audioName) { invoke<Void>(0xB138AAB8A70D3C69, audioName); } // 0xB138AAB8A70D3C69 0x3033EA1D
	inline void PLAY_PAIN(Ped ped, int painID, int p1, Any p3) { invoke<Void>(0xBC9AE166038A5CEC, ped, painID, p1, p3); } // 0xBC9AE166038A5CEC 0x874BD6CB
	inline void _PLAY_AMBIENT_SPEECH2(Ped ped, const char* speechName, const char* speechParam, Any p3) { invoke<Void>(0xC6941B4A3A8FBBB9, ped, speechName, speechParam, p3); } // 0xC6941B4A3A8FBBB9 0x444180DB
	inline void _PLAY_AMBIENT_SPEECH1(Ped ped, const char* speechName, const char* speechParam, Any p3) { invoke<Void>(0x8E04FEDD28D42462, ped, speechName, speechParam, p3); } // 0x8E04FEDD28D42462 0x5C57B85D
	inline void _PLAY_AMBIENT_SPEECH_WITH_VOICE(Ped p0, const char* speechName, const char* voiceName, const char* speechParam, bool p4) { invoke<Void>(0x3523634255FC3318, p0, speechName, voiceName, speechParam, p4); } // 0x3523634255FC3318 0x8386AE28
	inline void PLAY_PED_RINGTONE(const char* ringtoneName, Ped ped, bool p2) { invoke<Void>(0xF9E56683CA8E11A5, ringtoneName, ped, p2); } // 0xF9E56683CA8E11A5 0x1D530E47
	inline Any PLAY_POLICE_REPORT(const char* name, float p1) { return invoke<Any>(0xDFEBD56D9BD1EB16, name, p1); } // 0xDFEBD56D9BD1EB16 0x3F277B62
	inline void PLAY_SOUND(Player soundId, const char* audioName, const char* audioRef, bool p3, Any p4, bool p5) { invoke<Void>(0x7FF4944CC209192D, soundId, audioName, audioRef, p3, p4, p5); } // 0x7FF4944CC209192D 0xB6E1917F
	inline void PLAY_SOUND_FROM_COORD(int soundId, const char* audioName, float x, float y, float z, const char* audioRef, bool p6, int range, bool p8) { invoke<Void>(0x8D8686B622B88120, soundId, audioName, x, y, z, audioRef, p6, range, p8); } // 0x8D8686B622B88120 0xCAD3E2D5
	inline void PLAY_SOUND_FROM_ENTITY(int soundId, const char* audioName, Entity entity, const char* audioRef, bool p4, Any p5) { invoke<Void>(0xE65F427EB70AB1ED, soundId, audioName, entity, audioRef, p4, p5); } // 0xE65F427EB70AB1ED 0x95AE00F8
	inline void _0x5B9853296731E88D(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x5B9853296731E88D, p0, p1, p2, p3, p4, p5); } // 0x5B9853296731E88D 
	...
	inline void PLAY_STREAM_FROM_POSITION(float x, float y, float z) { invoke<Void>(0x21442F412E8DE56B, x, y, z); } // 0x21442F412E8DE56B 0x6FE5D865
	...
	inline BOOL PLAY_SYNCHRONIZED_AUDIO_EVENT(Any p0) { return invoke<BOOL>(0x8B2FD4560E55DD2D, p0); } // 0x8B2FD4560E55DD2D 0x507F3241
	...
	inline void _0xCA4CEA6AE0000A7E(Any p0) { invoke<Void>(0xCA4CEA6AE0000A7E, p0); } // 0xCA4CEA6AE0000A7E 
	inline BOOL PREPARE_ALARM(const char* alarmName) { return invoke<BOOL>(0x9D74AE343DB65533, alarmName); } // 0x9D74AE343DB65533 0x084932E8
	inline BOOL PREPARE_MUSIC_EVENT(const char* eventName) { return invoke<BOOL>(0x1E5185B72EF5158A, eventName); } // 0x1E5185B72EF5158A 0x534A5C1C
	inline Any PREPARE_SYNCHRONIZED_AUDIO_EVENT(const char* p0, Any p1) { return invoke<Any>(0xC7ABCACA4985A766, p0, p1); } // 0xC7ABCACA4985A766 0xE1D91FD0
	inline BOOL PREPARE_SYNCHRONIZED_AUDIO_EVENT_FOR_SCENE(Any p0, Any* p1) { return invoke<BOOL>(0x029FE7CD1B7E2E75, p0, p1); } // 0x029FE7CD1B7E2E75 0x7652DD49
	...
	inline void _0x5D2BFAAB8D956E0E() { invoke<Void>(0x5D2BFAAB8D956E0E); } // 0x5D2BFAAB8D956E0E 
	...
	inline void _0x9AC92EED5E4793AB() { invoke<Void>(0x9AC92EED5E4793AB); } // 0x9AC92EED5E4793AB 0xE67446E9
	inline void RELEASE_SOUND_ID(int soundId) { invoke<Void>(0x353FC880830B88FA, soundId); } // 0x353FC880830B88FA 0x9C080899
	inline void _0xCE4AC0439F607045() { invoke<Void>(0xCE4AC0439F607045); } // 0xCE4AC0439F607045 0x6096504C
	inline void _0x18EB48CFC41F2EA0(Any p0, float p1) { invoke<Void>(0x18EB48CFC41F2EA0, p0, p1); } // 0x18EB48CFC41F2EA0 0x308ED0EC
	inline void _0xB4BBFD9CD8B3922B(const char* p0) { invoke<Void>(0xB4BBFD9CD8B3922B, p0); } // 0xB4BBFD9CD8B3922B 0xD24B4D0C
	inline BOOL REQUEST_MISSION_AUDIO_BANK(const char* p0, bool p1, Any p2) { return invoke<BOOL>(0x7345BDD95E62E0F2, p0, p1, p2); } // 0x7345BDD95E62E0F2 0x916E37CA
	inline BOOL REQUEST_AMBIENT_AUDIO_BANK(const char* p0, bool p1, Any p2) { return invoke<BOOL>(0xFE02FFBED8CA9D99, p0, p1, p2); } // 0xFE02FFBED8CA9D99 0x23C88BC7
	inline BOOL REQUEST_SCRIPT_AUDIO_BANK(const char* p0, bool p1, Any p2) { return invoke<BOOL>(0x2F844A8B08D76685, p0, p1, p2); } // 0x2F844A8B08D76685 0x21322887
	inline void _SET_PED_TALK(Ped ped) { invoke<Void>(0x4ADA3F19BE4A6047, ped); } // 0x4ADA3F19BE4A6047 0x13777A0B
	inline void RESET_PED_AUDIO_FLAGS(Any p0) { invoke<Void>(0xF54BB7B61036F335, p0); } // 0xF54BB7B61036F335 0xDF720C86
	...
	inline void SET_AMBIENT_VOICE_NAME(Ped ped, const char* name) { invoke<Void>(0x6C8065A3B780185B, ped, name); } // 0x6C8065A3B780185B 0xBD2EA1A1
	inline void _0x9A53DED9921DE990(Any p0, Any p1) { invoke<Void>(0x9A53DED9921DE990, p0, p1); } // 0x9A53DED9921DE990 
	inline void SET_AMBIENT_ZONE_LIST_STATE(Any* p0, bool p1, bool p2) { invoke<Void>(0x9748FA4DE50CCE3E, p0, p1, p2); } // 0x9748FA4DE50CCE3E 0xBF80B412
	inline void SET_AMBIENT_ZONE_LIST_STATE_PERSISTENT(const char* ambientZone, bool p1, bool p2) { invoke<Void>(0xF3638DAE8C4045E1, ambientZone, p1, p2); } // 0xF3638DAE8C4045E1 0x5F5A2605
	...
	inline void SET_AMBIENT_ZONE_STATE_PERSISTENT(const char* ambientZone, bool p1, bool p2) { invoke<Void>(0x1D6650420CEC9D3B, ambientZone, p1, p2); } // 0x1D6650420CEC9D3B 0xC1FFB672
	inline void SET_ANIMAL_MOOD(Ped animal, int mood) { invoke<Void>(0xCC97B29285B1DC3B, animal, mood); } // 0xCC97B29285B1DC3B 0x3EA7C6CB
	inline void SET_AUDIO_FLAG(const char* flagName, bool toggle) { invoke<Void>(0xB9EFD5C25018725A, flagName, toggle); } // 0xB9EFD5C25018725A 0x1C09C9E0
	inline void SET_AUDIO_SCENE_VARIABLE(const char* scene, const char* variable, float value) { invoke<Void>(0xEF21A9EF089A2668, scene, variable, value); } // 0xEF21A9EF089A2668 0x19BB3CE8
	...
	inline void _0x4E404A9361F75BB2(const char* radioStation, const char* p1, bool p2) { invoke<Void>(0x4E404A9361F75BB2, radioStation, p1, p2); } // 0x4E404A9361F75BB2 0x128C3873
	inline void SET_CUTSCENE_AUDIO_OVERRIDE(const char* p0) { invoke<Void>(0x3B4BF5F0859204D9, p0); } // 0x3B4BF5F0859204D9 0xCE1332B7
	inline void SET_EMITTER_RADIO_STATION(const char* emitterName, const char* radioStation) { invoke<Void>(0xACF57305B12AF907, emitterName, radioStation); } // 0xACF57305B12AF907 0x87431585
	...
	inline void _0x159B7318403A1CD8(Any p0) { invoke<Void>(0x159B7318403A1CD8, p0); } // 0x159B7318403A1CD8 
	...
	inline void SET_INITIAL_PLAYER_STATION(const char* radioStation) { invoke<Void>(0x88795F13FACDA88D, radioStation); } // 0x88795F13FACDA88D 0x9B069233
	...
	inline void _0x8BF907833BE275DE(float p0, float p1) { invoke<Void>(0x8BF907833BE275DE, p0, p1); } // 0x8BF907833BE275DE 0x2CD26D69
	inline void SET_PED_IS_DRUNK(Ped ped, bool toggle) { invoke<Void>(0x95D2D383D5396B8A, ped, toggle); } // 0x95D2D383D5396B8A 0xD2EA77A3
	inline void _0x1B7ABE26CBCBF8C7(Any p0, Any p1, Any p2) { invoke<Void>(0x1B7ABE26CBCBF8C7, p0, p1, p2); } // 0x1B7ABE26CBCBF8C7 
	inline void _SET_PED_SCREAM(Ped ped) { invoke<Void>(0x40CF0D12D142A9E8, ped); } // 0x40CF0D12D142A9E8 
	...
	inline void SET_PLAYER_ANGRY(Ped playerPed, bool disabled) { invoke<Void>(0xEA241BB04110F091, playerPed, disabled); } // 0xEA241BB04110F091 0x782CA58D
	inline void _0x6FDDAD856E36988A(Any p0, bool p1) { invoke<Void>(0x6FDDAD856E36988A, p0, p1); } // 0x6FDDAD856E36988A 0x934BE749
	inline void _0x044DBAD7A7FA2BE5(const char* p0, const char* p1) { invoke<Void>(0x044DBAD7A7FA2BE5, p0, p1); } // 0x044DBAD7A7FA2BE5 0x8AD670EC
	inline void _0xDA07819E452FFE8F(Any p0) { invoke<Void>(0xDA07819E452FFE8F, p0); } // 0xDA07819E452FFE8F 
	...
	inline void _0x774BD811F656A122(const char* radioStation, bool p1) { invoke<Void>(0x774BD811F656A122, radioStation, p1); } // 0x774BD811F656A122 0xB1FF7137
	...
	inline void SET_RADIO_TO_STATION_NAME(const char* stationName) { invoke<Void>(0xC69EDA28699D5107, stationName); } // 0xC69EDA28699D5107 0x7B36E35E
	inline void SET_RADIO_TRACK(const char* radioStation, const char* radioTrack) { invoke<Void>(0xB39786F201FEE30B, radioStation, radioTrack); } // 0xB39786F201FEE30B 0x76E96212
	...
	inline void SET_STATIC_EMITTER_ENABLED(const char* emitterName, bool toggle) { invoke<Void>(0x399D2D3B33F1B8EB, emitterName, toggle); } // 0x399D2D3B33F1B8EB 0x91F72E92
	...
	inline void SET_VARIABLE_ON_SOUND(int soundId, Any* p1, float p2) { invoke<Void>(0xAD6B3148A78AE9B6, soundId, p1, p2); } // 0xAD6B3148A78AE9B6 0x606EE5FA
	inline void SET_VARIABLE_ON_STREAM(const char* p0, float p1) { invoke<Void>(0x2F9D3834AEB9EF79, p0, p1); } // 0x2F9D3834AEB9EF79 0xF67BB44C
	inline void GET_PLAYER_HEADSET_SOUND_ALTERNATE(const char* p0, float p1) { invoke<Void>(0xBCC29F935ED07688, p0, p1); } // 0xBCC29F935ED07688 0xD63CF33A
	inline void _0x733ADF241531E5C2(const char* name, float p1) { invoke<Void>(0x733ADF241531E5C2, name, p1); } // 0x733ADF241531E5C2 0x62D026BE
	...
	inline void _0xF1F8157B8C3F171C(Any p0, const char* p1, const char* p2) { invoke<Void>(0xF1F8157B8C3F171C, p0, p1, p2); } // 0xF1F8157B8C3F171C 0x1C0C5E4C
	inline void _0xC1805D05E6D4FE10(Vehicle vehicle) { invoke<Void>(0xC1805D05E6D4FE10, vehicle); } // 0xC1805D05E6D4FE10 0x7ABB89D2
	inline void SET_VEH_RADIO_STATION(Vehicle vehicle, const char* radioStation) { invoke<Void>(0x1B9C0099CB942AC6, vehicle, radioStation); } // 0x1B9C0099CB942AC6 0xE391F55F
	...
	inline void START_ALARM(const char* alarmName, bool p2) { invoke<Void>(0x0355EF116C4C97B2, alarmName, p2); } // 0x0355EF116C4C97B2 0x703F524B
	inline BOOL START_AUDIO_SCENE(const char* scene) { return invoke<BOOL>(0x013A80FC08F6E4F2, scene); } // 0x013A80FC08F6E4F2 0xE48D757B
	...
	inline void STOP_ALARM(const char* alarmName, bool toggle) { invoke<Void>(0xA1CADDCD98415A41, alarmName, toggle); } // 0xA1CADDCD98415A41 0xF987BE8C
	inline void STOP_ALL_ALARMS(bool stop) { invoke<Void>(0x2F794A877ADD4C92, stop); } // 0x2F794A877ADD4C92 0xC3CB9DC6
	inline void STOP_AUDIO_SCENE(const char* scene) { invoke<Void>(0xDFE8422B3B94E688, scene); } // 0xDFE8422B3B94E688 0xA08D8C58
	...
	inline void STOP_PED_SPEAKING(Ped ped, bool shaking) { invoke<Void>(0x9D64D7405520E3D3, ped, shaking); } // 0x9D64D7405520E3D3 0xFF92B49D
	...
	inline BOOL STOP_SYNCHRONIZED_AUDIO_EVENT(Any p0) { return invoke<BOOL>(0x92D6A88E64A94430, p0); } // 0x92D6A88E64A94430 0xADEED2B4
	inline BOOL TRIGGER_MUSIC_EVENT(const char* eventName) { return invoke<BOOL>(0x706D57B0F50DA710, eventName); } // 0x706D57B0F50DA710 0xB6094948
	inline void UNFREEZE_RADIO_STATION(const char* radioStation) { invoke<Void>(0xFC00454CF60B91DD, radioStation); } // 0xFC00454CF60B91DD 0x4D46202C
	inline void RELEASE_NAMED_SCRIPT_AUDIO_BANK(const char* audioBank) { invoke<Void>(0x77ED170667F50170, audioBank); } // 0x77ED170667F50170 0x16707ABC
	inline void _0x11579D940949C49E(Any p0) { invoke<Void>(0x11579D940949C49E, p0); } // 0x11579D940949C49E 
	...
	inline void _0x031ACB6ABA18C729(const char* radioStation, const char* p1) { invoke<Void>(0x031ACB6ABA18C729, radioStation, p1); } // 0x031ACB6ABA18C729 0xBE998184
	inline void _0x0150B6FF25A9E2E5() { invoke<Void>(0x0150B6FF25A9E2E5); } // 0x0150B6FF25A9E2E5 0x1134F68B
	inline void _0x7EC3C679D0E7E46B(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x7EC3C679D0E7E46B, p0, p1, p2, p3); } // 0x7EC3C679D0E7E46B 
	...
	inline void REGISTER_SCRIPT_WITH_AUDIO(Any p0) { invoke<Void>(0xC6ED9D5092438D91, p0); } // 0xC6ED9D5092438D91 0xA6203643
...
namespace GRAPHICS
{
	...
	inline void _SET_DRAW_BEHIND_PAUSE_SCREEN(bool p0) { invoke<Void>(0xC6372ECD45D73BCD, p0); } // 0xC6372ECD45D73BCD 0xF8FBCC25
...
namespace NETSHOP
{
	...
	inline BOOL _NETWORK_SHOP_BASKET_DELETE() { return invoke<BOOL>(0xFA336E7F40C0A0D0); } //0xFA336E7F40C0A0D0
...
namespace STREAMING
{
	...
	inline void ADJUST_RENDER_DISTANCE_SCALING(float p0) { invoke<Void>(0xA76359FC80B2438E, p0); } // 0xA76359FC80B2438E 0xE5612C1A
